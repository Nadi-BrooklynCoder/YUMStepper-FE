...
with_node \
  ...
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-secure-store" "expo-speech" "expo-system-ui"

...
import { LEGACY_childrenWithOverriddenStyle, childrenWithOverriddenStyle } from './utils';
import PagerViewNativeComponent, { Commands as PagerViewNativeCommands } from './specs/PagerViewNativeComponent';
import LEGACY_PagerViewNativeComponent, { Commands as LEGACY_PagerViewNativeCommands } from './specs/LEGACY_PagerViewNativeComponent';
...
class PagerViewInternal extends React.Component {
  constructor() {
    super(...arguments);
  ...
  get nativeCommandsWrapper() {
    return this.props.useLegacy ? LEGACY_PagerViewNativeCommands : PagerViewNativeCommands;
  }
  ...
  render() {
    ...
    if (Platform.OS === 'ios' && this.props.useLegacy) {
      return /*#__PURE__*/React.createElement(LEGACY_PagerViewNativeComponent, _extends({}, this.props, {
        ref: ref => {
          this.pagerView = ref;
        },
...
export const PagerView = /*#__PURE__*/React.forwardRef((props, ref) => {
  const {
    useNext,
    ...rest
  } = props;
  return /*#__PURE__*/React.createElement(PagerViewInternal, _extends({}, rest, {
    useLegacy: !useNext,
    ref: ref
  }));
});
